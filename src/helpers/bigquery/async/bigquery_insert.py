"""
Modified version of: https://raw.githubusercontent.com/talkiq/gcloud-aio/master/bigquery/gcloud/aio/bigquery/bigquery.py
"""
...
from app.libs.bq.async.auth import Token
...
class Table(object):
    ...
    async def insert(self, rows, skip_invalid=False, ignore_unknown=True,
        ...
        logger.debug('response code: %d', response.status)
