"""
Ref: https://raw.githubusercontent.com/talkiq/gcloud-aio/master/auth/gcloud/aio/auth/auth.py
...
async def acquire_token(session, service_data: dict,
    ...
    response = await session.post(url, data=payload, headers=headers,
                                  params=None, ssl=False, timeout=60)
